...
APPDIR="$BUILDDIR/payblk-chrome-extension"
ZIPFILE="payblk-chrome-extension.zip"
...
echo "${OpenColor}${Green}* Generating payblk bundle...${CloseColor}"
grunt
checkOK
...
echo "${OpenColor}${Yellow}\nThe Chrome Extension is ready at $BUILDDIR/payblk-chrome-extension.zip${CloseColor}"
